...
- [[#consideraciones][Consideraciones]]
  ...
  - [[#problemas-con-estimadores][Problemas con estimadores]]
:END:
...
método Monte Carlo para integrales---. Es decir la probabilidad de que nuestra
estimación no diste mas de $\epsilon$ unidades del verdadero valor.
