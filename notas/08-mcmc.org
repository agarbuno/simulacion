...
como el promedio de nuestra distribución, /aka/ el individuo promedio no es tan
común.
...
puntos de más alta densidad no corresponden a los puntos que viven en las regiones de mayor volumen
(probabilidad).
...
#+REVEAL: split
#+attr_latex: :options [Programación orientada a objetos]
#+begin_remark
...
#+attr_latex: :options [Consistencia de muestreo por aceptación-rechazo]
#+begin_lemma
...
#+attr_latex: :options [Cadena de Markov]
#+begin_definition
...
#+REVEAL: split
#+attr_latex: :options [Aleatoriedad y distribución estacionaria]
#+begin_remark
    El resultado anterior es un resultado muy poderoso analiticamente. Sin embargo, no nos da herramientas para
    verificar que nuestra cadena de Markov ha alcanzado la distribución límite. ¿Cómo verificarías que una muestra satisface la distribución estacionaria? 
#+end_remark


#+attr_latex: :options [Comportamiento asintótico de Metropolis-Hastings]
#+begin_lemma
...
other attached packages:
 [1] R6_2.5.1        scales_1.2.1    patchwork_1.1.2 lubridate_1.9.2
