...
:END:
#+PROPERTY: header-args:R :session mcmc :exports both :results output org :tangle ../rscripts/08-mcmc.R :mkdirp yes :dir ../
...
\end{align}
Gráfiquemos el valor central de estas variables aleatorias y sus percentiles del $2.5\%$ y $97.5\%$
