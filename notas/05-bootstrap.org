...
($\mathsf{iid}$), y $\hat \theta_n=t(X_1, X_2, \ldots, X_n)$ una estadística. Supongamos
que los valores que obervamos son $x_1, x_2,\ldots, x_n$.

#+REVEAL: split
La *distribución de remuestreo* de $\hat \theta_n$ es la distribución de $\theta^*_n=t(X_1^*, X_2^*,
